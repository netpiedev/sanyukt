...
const values = [
  {
    ...
    description: "Sanyukt envisions a society where women are empowered, communities are skilled, and environmental sustainability is prioritized.",
  },
  {
    title: "Mission",
    icon: <Lightbulb className="h-8 w-8 text-[#2cb1e3]" strokeWidth={2.5} />,
    description: "To create sustainable change through women empowerment initiatives, skill development programs, and environmental conservation.",
  },
  {
    title: "Philosophy",
    icon: <Star className="h-8 w-8 text-[#2cb1e3]" fill="currentColor" strokeWidth={0} />,
    description: "We believe real social change begins at the grassroots. By empowering youth to lead initiatives and collaborating with communities.",
  },
];
