    ...
    <section className="mx-auto w-full px-6 py-16 sm:px-8 md:py-24">
      <div className="mx-auto w-full max-w-[914px]">
        <div className="mb-8 text-center md:text-left">
          <h2 
            className="inline-block bg-linear-to-r from-[#39B54A] to-[#25AAE1] bg-clip-text text-transparent  text-[2rem] font-semibold tracking-tight sm:text-[2.25rem]"
          >
            Membership Form
          </h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          <div className="flex flex-col gap-6 md:flex-row md:justify-between">
            <div className="flex w-full flex-col gap-2 md:w-[440px]">
              <label htmlFor="fullName" className="text-[0.95rem] font-bold text-[#1a2434]">
                Full Name
              </label>
              <input
                type="text"
            ...
            <div className="flex w-full flex-col gap-2 md:w-[440px]">
              <label htmlFor="email" className="text-[0.95rem] font-bold text-[#1a2434]">
                Email Address
              </label>
              <input
                type="email"
          ...
          <div className="flex flex-col gap-6 md:flex-row md:justify-between">
            <div className="flex w-full flex-col gap-2 md:w-[440px]">
              <label htmlFor="mobile" className="text-[0.95rem] font-bold text-[#1a2434]">
                Mobile number
              </label>
              <input
                type="tel"
            ...
            <div className="flex w-full flex-col gap-2 md:w-[440px]">
              <label htmlFor="dob" className="text-[0.95rem] font-bold text-[#1a2434]">
                Date of Birth
              </label>
              <input
                type="text"
          ...
          <div className="flex flex-col gap-6 md:flex-row md:justify-between">
            <div className="flex w-full flex-col gap-2 md:w-[440px]">
              <label htmlFor="gender" className="text-[0.95rem] font-bold text-[#1a2434]">
                Gender
              </label>
            ...
            <div className="flex w-full flex-col gap-2 md:w-[440px]">
              <label htmlFor="state" className="text-[0.95rem] font-bold text-[#1a2434]">
                State
              </label>
              <div className="relative">
                <select
          ...
          <div className="flex w-full flex-col gap-2">
            <label htmlFor="reason" className="text-[0.95rem] font-bold text-[#1a2434]">
