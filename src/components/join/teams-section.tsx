    ...
    <section className="mx-auto w-full px-6 py-16 sm:px-8 md:py-24">
      <div className="mx-auto flex w-full max-w-[1072px] flex-col items-center">
        <div className="mb-16 text-center md:mb-20">
          <h2 className="mb-4 text-[2.25rem] font-semibold leading-[1.2] tracking-tight text-[#1a2434] sm:text-[2.75rem]">
            Join Our Teams - <br />
          ...
          <p className="mx-auto max-w-[650px] text-[0.95rem] leading-[1.65] text-[#697586] sm:text-[1.05rem]">
            At Sanyukt, our founder envisions a youth platform where young
            people can actively contribute to social work—not just as
            volunteers, but also in senior management roles. Explore exciting
            opportunities to make a real impact and shape the future of
            communities. Choose a team that aligns with your passion and skills
          </p>
        </div>
        ...
        <div className="flex w-full flex-col gap-16 md:gap-24">
          <div className="flex flex-col items-center gap-8 md:flex-row md:justify-between lg:gap-16">
            <div className="flex w-full flex-col items-center text-center md:max-w-[480px] md:items-start md:text-left">
              ...
              <p className="mb-6 text-[0.95rem] leading-[1.65] text-[#333840] sm:text-[1rem]">
                Lead and shape the future of Sanyukt! Roles include President,
                Vice President, General Secretary, Joint Secretary, Treasurer,
                and Advisor. Serve a 2-year term, bring your leadership, and
                help drive meaningful social change.
                <br />
                Eligibility: 18+, higher secondary education, 2+ years in
                social/non-profit work, no criminal record.
              </p>
              <div>
                <Link
                  href="#"
          ...
          <div className="flex flex-col items-center gap-8 md:flex-row-reverse md:justify-between lg:gap-16">
            <div className="flex w-full flex-col items-center text-center md:max-w-[480px] md:items-start md:text-left">
              ...
              <p className="mb-6 text-[0.95rem] leading-[1.65] text-[#333840] sm:text-[1rem]">
                Work from home and fuel Sanyukt&apos;s digital impact!
                Contribute through content writing, graphic design, video
                editing, tech support, and social media campaigns. Help us
                engage communities and expand our online presence.
              </p>
              <div>
                <Link
                  href="#"
          ...
          <div className="flex flex-col items-center gap-8 md:flex-row md:justify-between lg:gap-16">
            <div className="flex w-full flex-col items-center text-center md:max-w-[480px] md:items-start md:text-left">
              ...
              <p className="mb-6 text-[0.95rem] leading-[1.65] text-[#333840] sm:text-[1rem]">
                Manage and grow the Sanyukt Internship Program! Key roles
                include Director, Joint Director, Head of Operations, and HR
                Manager. Term: 6 months - 1 year. Responsibilities include
                program supervision, event management, volunteer coordination,
                and more.
              </p>
              <div>
                <Link
